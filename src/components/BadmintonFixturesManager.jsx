                ...
                >
                  ...
                  <div>
                    ...
                    {(() => {
                      ...
                      // DEFAULT STATE: OFF (Clean Neutral, zero blinking, solid)
                      return (
                        <button
                          type="button"
                          onClick={(e) => {
                          ...
                          title={`Live Stream is OFF. Click to start TV Live Stream in new tab for "${formatTournamentName(match.matchName)}"`}
                        >
